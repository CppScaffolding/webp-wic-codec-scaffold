# -----------------------------------------------------------------------------
# DEPS file for webp-wic-codec scaffold
# =========================================
# -----------------------------------------------------------------------------

# This file is used to manage the dependencies of the
# webp-wic-codec-scaffold scaffold repo.
...
deps = {
  ...
  # this
  # line
  'webp-wic-codec': 'https://chromium.googlesource.com/webm/webp-wic-codec.git@{webp-wic-codec_revision}',
  # keep
  # this
  # line
}
